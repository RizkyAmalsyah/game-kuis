  ...
  <main>
    ...
    <div class="container">
      ...
      <div class="answer-content">
        <form action="{{ route('question-1-answer', $quiz->id) }}" method="post">
          @csrf
      ...
      <div class="notes">
        <div class="alert alert-danger rounded-4 text-center">
          Ayo kejar poin di soal pertama!
        </div>
      </div>
      <div class="timer">
...
@push('addon-script')
  <script>
    ...
    setTimeout(function () {
      window.location.href= '{{ route('question-1-notime', $quiz->id) }}'; // the redirect goes here
    },10000);
  </script>
@endpush
