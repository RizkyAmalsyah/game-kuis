  ...
  <main>
    ...
    <div class="container">
      ...
      <div class="answer-content">
        <form action="{{ route('question-2-answer', $quiz->id) }}" method="post">
          @csrf
      ...
      <div class="notes">
        @if ($data->score > 0)
          <div class="alert alert-danger rounded-4 text-center">
            Go go lanjutkan menjawab dengan benar!
          </div>
        @else
          <div class="alert alert-danger rounded-4 text-center">
            Kesalahan Sebelumnya Jangan Khawatir, Fokus Jawab Soal Nomor 2 ini!
          </div>
        @endif
      </div>
      <div class="timer">
...
<script>
  ...
  setTimeout(function () {
      window.location.href= '{{ route('question-2-notime', $quiz->id) }}'; // the redirect goes here
    },10000);
</script>
@endpush
