...
@section('content')
  <main>
    ...
    <div class="container">
      ...
      <div class="next">
        <a class="btn next text-center rounded-pill fw-bold" href="{{ route('question-5', $item->quiz->id) }}">
          Lanjut
        </a>
      </div>
    </div>
...
@push('addon-script')
  <script>
    ...
    setTimeout(function () {
      window.location.href= '{{ route('question-5', $item->quiz->id) }}'; // the redirect goes here
    },10000);
  </script>
@endpush