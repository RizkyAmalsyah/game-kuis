...
class Question4Controller extends Controller
{
  public function index(Request $request, $id)
  {
    ...
    return view('pages.question-4.question4', [
      'item' => $item,
      'quiz' => $quiz,
      'data' => $data
    ]);
  ...
  public function store(Request $request, $id)
  {
    ...
    return redirect()->route('question-4-result', $data->id);
  }
  ...
  public function process(Request $request, $id)
  {
    ...
    return view('pages.question-4.question4-result', [
      'item' => $item,
  ...
  public function notime(Request $request, $id)
  {
    ...
    return view('pages.question-4.question4-notime', [
      'quiz' => $quiz,
      'item' => $item,
      'question' => $item->question_id,
      'quiz_name' => $item->question->name,
